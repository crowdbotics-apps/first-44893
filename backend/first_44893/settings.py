"""
Django settings for first_44893 project.
...
WSGI_APPLICATION = 'first_44893.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "first_44893 API",
    "DESCRIPTION": "API documentation for first_44893 App",
    "VERSION": "v1",
}
